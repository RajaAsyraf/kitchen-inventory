                                    ...
                                    <form action="{{ route('items.update', [$item->id]) }}" method="POST">
                                        ...
                                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                            <div class="flex flex-col">
                                                ...
                                                <input type="text" name="name" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Item name" value="{{ $item->name }}" required>
                                            </div>
                                            <div class="flex items-center space-x-4">
                                                <div class="flex flex-col">
                                                    <label class="leading-loose">Quantity</label>
                                                    <div class="relative focus-within:text-gray-600 text-gray-400">
                                                        <input type="number" name="quantity" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" value="{{ $item->quantity }}" required>
                                                    </div>
                                                </div>
                                                <div class="flex flex-col w-full">
                                                    ...
                                                    <div class="relative focus-within:text-gray-600 text-gray-400">
                                                        <select name="unit" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" required>
                                                            ...
                                                            <option value="percentage" {{ $item->unit == 'percentage' ? 'selected' : '' }}>Percentage (%)</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex flex-col">
                                                ...
                                                <div class="relative focus-within:text-gray-600 text-gray-400">
                                                    <input type="date" name="expired_at" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="25/02/2020" value="{{ $item->expired_at->format('Y-m-d') }}" required>
